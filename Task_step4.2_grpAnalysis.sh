...
outDir=${workDir}/grp-NPE-PPE          						# where output will be written (should match step3)
...
compList=(knowfilt2)	            								# matches decon prefixes, and will be prefix of output files
compLen=${#compList[@]}
...
namA=(NegPredErr)										# names of behaviors from arrA. Must be same length as arrA
namB=(PosPredErr)
