...
deconPref=(knowfilt)				            			# array of prefix for each planned decon (length must equal sum of $deconNum)
...
3dDeconvolve -input run-01_knowfilt_scale+tlrc run-02_knowfilt_scale+tlrc \
     ...
     -stim_times_AM1 14 timings/Phase_2_HHH+LLL.txt 'dmBLOCK' -stim_label 14 confirm \
     -stim_times_AM1 15 timings/Phase_2_HHL+LLH.txt 'dmBLOCK' -stim_label 15 disconfirm \
     -stim_times_AM1 16 timings/Phase_2_HLH.txt 'dmBLOCK' -stim_label     16 p2hlh \
     -stim_times_AM1 17 timings/Phase_2_HLL.txt 'dmBLOCK' -stim_label     17 p2hll \
     -stim_times_AM1 18 timings/Phase_2_LHH.txt 'dmBLOCK' -stim_label     18 p2lhh \
     -stim_times_AM1 19 timings/Phase_2_LHL.txt 'dmBLOCK' -stim_label     19 p2lhl \
     -noFDR -nofullf_atall \
     -x1D X.${phase}.xmat.1D \
     -xjpeg X.${phase}.jpg \
